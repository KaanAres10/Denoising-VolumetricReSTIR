...
BASE_NAME = f"Bistro_ReSTIRImprovedOrbit_{stamp}"
...
def render_graph():
    g = RenderGraph("Bistro VolumetricReSTIR (Improved) Orbit")

    loadRenderPassLibrary("AccumulatePass.dll")
    loadRenderPassLibrary("VolumetricReSTIR.dll")
    loadRenderPassLibrary("ToneMapper.dll")

    # Spend the "denoiser budget" here:
    # - more candidates (mInitialM)
    # - more spatial reuse work
    vrestir = createPass(
        "VolumetricReSTIR",
        {
