# ============================================================
# Plume: Volumetric ReSTIR / OIDN (GPU)
# Graph: VolumetricReSTIR -> AccumulatePass -> OIDNGPUPass -> ToneMapper
# ============================================================
...
def render_graph():
    g = RenderGraph("Volumetric ReSTIR on OIDN(GPU)")
    ...
    OIDNPass       = createPass("OIDNGPUPass")
