...
def render_graph():
    g = RenderGraph("Volumetric ReSTIR on OptiX")
    ...
    OptixPass        = createPass("OptixDenoiserRecent", gOptixParams)
    ...
    g.addPass(OptixPass,        "OptixPass")
    g.addPass(ToneMapper,       "ToneMapper")

    g.addEdge("VolumetricReSTIR.accumulated_color", "AccumulatePass.input")
    g.addEdge("AccumulatePass.output",              "OptixPass.color")
    g.addEdge("OptixPass.output",                   "ToneMapper.src")
